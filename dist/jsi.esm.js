/*!
    ...
    */
import{reactive as e}from"vue";function t(){return{set:
/**
     * ### Set function
...
/**
     ...
     */,get:function(t){
/** @type {Object} */
const r=JSON.stringify(localStorage.getItem(t));if(t in localStorage)return e(r);{const e=new Error;throw e.name="GetItem Key Error",e.message=`returned data can't be '${r}', this happens if theres no key with the of '${t}'`,e}}
/**
     * 
     * @param {string} key 
     */,remove:function(e){if(!(e in localStorage)){const t=new Error;throw t.name="RemoveItem Key Error",t.message=`data can't be removed if isn't there, try changing '${e}' to another thing`,t}localStorage.removeItem(e)},clear:function(){localStorage.clear()}}}export{t as useJSIStorage};
